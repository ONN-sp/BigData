                ...
                new KeyedProcessFunction<String, WaterSensor, String>() {
                    ...
                    public void open(Configuration parameters) throws Exception {
                        ...
                        StateTtlConfig ttlConfig = StateTtlConfig
                                ...
                                .build();
                        // 状态描述器启用TTL
                        ValueStateDescriptor<Integer> lastValueStateDescriptor = new ValueStateDescriptor<Integer>("lastValue", Integer.class);
                        // 启用TTL
                        lastValueStateDescriptor.enableTimeToLive(ttlConfig);
                        // 初始化状态
                    ...
                    public void processElement(WaterSensor value, Context ctx, Collector<String> out) throws Exception {
                        // 获取状态值，打印
                        out.collect("传感器=" + value.getId() + "，当前水位值=" + value.getValue() + "，上一条水位值=" + lastValueState.value());
                        // 更新状态值
